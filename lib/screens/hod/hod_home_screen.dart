...
class HodHomeScreen extends StatefulWidget {
  ...
  const HodHomeScreen({Key? key, required this.user}) : super(key: key);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: _buildStatCard('Teachers',
                              _teachers.length.toString(), Icons.person, Colors.orange),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: _buildStatCard('Subjects',
                              _subjects.length.toString(), Icons.book, Colors.blue),
                        ),
                      ],
                    ),
                  ),
                        ...
                        _buildActionCard(
                          ...
                          () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const HodAllocateSubjectScreen(),
                              ),
                            ).then((_) => _loadData());
                          },
                        ),
                        ...
                        _subjects.isEmpty
                            ? const Center(
                                child: Padding(
                                  ...
                                  child: Text('No subjects allocated yet',
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: Text(teacher.employeeId ?? 'N/A',
                          style:
