        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              _buildInfoTile('Name', widget.user.name, false),
              _buildInfoTile('Email', widget.user.email, false),
              _buildInfoTile('Roll No', widget.user.rollNo ?? 'N/A', false),
              _buildInfoTile('Class', widget.user.class_ ?? 'N/A', false),
              _buildInfoTile('Section', widget.user.section ?? 'N/A', false),
              _buildPhoneField(),
              if (_isEditing) ...[
                const SizedBox(height: 24),
                Row(
